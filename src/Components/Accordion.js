  ...
  return (
    <div className="relative">
      <div
        ...
        className={`flex items-center gap-5 text-2xl text-center font-sans font-medium tracking-tight px-6 py-8 bg-gray-50 rounded-md shadow-lg shadow-gray-600/30 cursor-pointer text-zinc-900 capitalize mb-2 border-t-4 border-gray-50 transition-all duration-300 ${
      ...
      >
        ...
        <p className="mr-auto">{question.question}</p>
